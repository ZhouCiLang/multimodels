...
if __name__ == '__main__':
    ...
    parser.add_argument('--threshold', type=int, default=10, help='Trained model weights')
    ...
    pickle_path = '/userhome/code/MinkLocMultimodal-master/robotcar_seasons_benchmark/'+ args.weights[10:-3]+'pickle'
    results_file = pickle_path[:-6]+'txt'
    ...
    ##data:10894 	 embedding:10894 	 datasets:6954	 1872 test images/ts
...
#             print('query_ts:\n', query_ts)
    ...
    #28 missing scans in reference traversal, db_ts len:6926
    print('{} missing scans in reference traversal'.format(missing_scans))
    print('db_ts len:{}\n'.format(len(db_ts)))

    threshold = args.threshold      # 5 meter threshold for coarse localization
