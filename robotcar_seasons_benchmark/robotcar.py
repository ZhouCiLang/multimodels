...
class RobotCarDataset:
    ...
    def __init__(self, dataset_root, lidar_subfolder='pointclouds/', lidar_timestamp=''):
        ...
        self.lidar_timestamps_file = self.lidar_subfolder
        ...
        if not os.path.exists(cached_indexes_file):
            ...
            print('Cache index right:, tx_ndx', self.lidar_ts_ndx)
        else:
...
if __name__ == '__main__':
    root = '/userhome/datasets/RobotCar_only_cloud/'
