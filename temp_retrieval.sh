...
###ours
/opt/conda/envs/name/bin/python ./eval/eval_retrieval.py --config ./config/config_baseline_multimodal_sketchRGB.txt --model_config ./models/svtinfer256.txt --weights ./weights/model_SVTinfer256_20231231_0317_final.pth >./results/ours_svt_sketch_oxford_retrieval.txt


##for kitti
###ours
/opt/conda/envs/name/bin/python ./eval/eval_kitti_retrieval.py --config ./config/config_baseline_multimodal_sketchRGB.txt --model_config ./models/svtinfer256.txt --weights ./weights/model_SVTinfer256_20231231_0317_final.pth >./results/ours_svt_sketch_kitti_retrieval.txt


/opt/conda/envs/name/bin/python ./eval/eval_retrieval.py --config ./config/config_baseline_multimodal.txt --model_config ./models/svtinfer256.txt --weights ./weights/model_SVTinfer256_20231230_1822_final.pth >./results/ours_svt__oxford_retrieval.txt


##for kitti
###ours
/opt/conda/envs/name/bin/python ./eval/eval_kitti_retrieval.py --config ./config/config_baseline_multimodal.txt --model_config ./models/svtinfer256.txt --weights ./weights/model_SVTinfer256_20231230_1822_final.pth >./results/ours_svt_kitti_retrieval.txt
