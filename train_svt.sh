...
/opt/conda/envs/name/bin/python ./training/train.py --config ./config/config_baseline_multimodal_sketchRGB.txt --model_config ./models/svtcon256.txt >./logs/svtinferall256_sketchRGB_con1.txt
